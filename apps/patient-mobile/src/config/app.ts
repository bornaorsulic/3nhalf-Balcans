// Product naming and deployment switches. Placeholder name until the team picks one.
export const APP_NAME = "Healthspan";
...
export const PATIENT_ID = process.env.NEXT_PUBLIC_PATIENT_ID ?? "demo-patient";
