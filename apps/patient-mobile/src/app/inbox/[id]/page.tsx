...
import { Card, LoadingCards, SectionTitle } from "@/components/ui";
import { getApi } from "@/lib/api";
import { useAppointmentQuestions, useSummaries } from "@/lib/api/hooks";
...
export default function SummaryPage() {
  ...
  if (!summary || summary.status !== "approved" || !summary.body) {
    return (
      <div className="pb-8">
        <PageHeader title="Not available yet" backHref="/inbox" />
  ...
  return (
    <div className="pb-8">
      <PageHeader title={summary.title} backHref="/inbox" />
      <div className="px-5">
