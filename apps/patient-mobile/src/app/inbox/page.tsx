...
import { Card, LinkCard, LoadingCards, SectionTitle, StatusPill } from "@/components/ui";
import { getApi } from "@/lib/api";
import { useAppointmentQuestions, useProfile, useSummaries } from "@/lib/api/hooks";
import type { AppointmentQuestion } from "@/lib/api/types";
    ...
    <>
      ...
      {!summaries ? (
        ...
        <div className="space-y-2.5">
          {summaries.map((s) =>
            s.status === "approved" ? (
              <LinkCard key={s.id} href={`/inbox/${s.id}`}>
