...
import { useSummaries } from "@/lib/api/hooks";
import { cx } from "./ui";
...
export function AppShell({ children }: { children: ReactNode }) {
  return (
    <div className="flex h-dvh justify-center sm:items-center sm:p-6">
      <div className="relative flex h-full w-full max-w-[430px] flex-col overflow-hidden bg-canvas sm:max-h-[900px] sm:rounded-[2.5rem] sm:shadow-frame">
