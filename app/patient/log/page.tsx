...
import { Button, Card, Chip, LoadingCards, SectionTitle, cx } from "@/components/patient/ui";
import { getApi } from "@/lib/patient-api";
import { useDiary } from "@/lib/patient-api/hooks";
import type { DiaryEntry, DiaryEntryInput, Scale5, Severity, SymptomLog } from "@/lib/patient-api/types";
      ...
      {entries.map((e) => (
        <li key={e.id} className="rounded-card bg-surface p-3.5 shadow-card">
          <div className="flex items-baseline justify-between gap-2">
            <p className="text-sm font-semibold first-letter:uppercase">{formatRelativeDay(e.date)}</p>
